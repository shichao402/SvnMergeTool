#!/bin/bash
# Test GitHub Actions workflow locally using act in WSL2
# Usage: wsl bash scripts/test_workflow_local_wsl2.sh [workflow-file] [job-name]
...
echo "=========================================="
echo "Testing GitHub Actions workflow locally (WSL2)"
echo "=========================================="
echo ""
...
if ! command -v act &> /dev/null; then
    ...
    bash scripts/setup_act_wsl2.sh
    if [ $? -ne 0 ]; then
